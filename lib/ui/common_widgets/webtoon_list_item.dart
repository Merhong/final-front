                    ...
                    children: [
                      ...
                      Container(
                        constraints: BoxConstraints(
                            maxWidth: sizeGetScreenWidth(context) * 0.235),
                ...
                : webtoonDTO.webtoonSpeciallyEnum == "완결"
                    ? Row(
                        children: [
                          ...
                          Container(
                            constraints: BoxConstraints(
                                maxWidth: sizeGetScreenWidth(context) * 0.225),
                            child: Text("${webtoonDTO.title}",
                                style:
                    ...
                    : webtoonDTO.episodeUpdatedAt != null &&
                            DateTime.now()
                                    .difference(webtoonDTO.episodeUpdatedAt!)
                                    .inHours <
                                50
                        ? Row(
                            children: [
                              ...
                              Container(
                                constraints: BoxConstraints(
                                    maxWidth:
                                        sizeGetScreenWidth(context) * 0.225),
                                child: Text("${webtoonDTO.title}",
                        ...
                        : Container(
                            constraints: BoxConstraints(
                                maxWidth: sizeGetScreenWidth(context) * 0.28),
                            child: Text("${webtoonDTO.title}",
                                style:
                                    Theme.of(context).textTheme.displayMedium,
                                overflow: TextOverflow.ellipsis),
        ...
        webtoonDTO.isInterest == true
            ...
            : Row(
                children: [
                  Container(
                      constraints: BoxConstraints(
                          maxWidth: sizeGetScreenWidth(context) * 0.195),
                      // child: Text("${webtoonDTO.authorNicknameList!.map((str) => str).toList().join('/').replaceAll(' ', '')} ",
                      child: Text(
                          "${webtoonDTO.authorNicknameList!.toList().join('/').replaceAll(' ', '')} ",
                          style: Theme.of(context).textTheme.bodySmall,
                          overflow: TextOverflow.ellipsis)),
                  Container(
                      child: Text(
                          "★ ${(webtoonDTO.starScore! / (webtoonDTO.starCount == 0 ? 1 : webtoonDTO.starCount!)).toStringAsFixed(2)}",
                          style: Theme.of(context).textTheme.bodySmall,
                          maxLines: 1)),
                ],
              ),
