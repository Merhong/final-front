...
class AlertDialogStar extends ConsumerStatefulWidget {
  AlertDialogStar(
      {super.key, required this.webtoonName, required this.episodeName});
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    style: ButtonStyle(
                        backgroundColor:
                            MaterialStatePropertyAll(CommonColors.grey)),
                    onPressed: () {
                ...
                Expanded(
                  child: ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor:
                          MaterialStatePropertyAll(CommonColors.green),
                    ),
                    onPressed: () {
                      print("별점주기버튼누름 value:${value.toInt()}");
                      ref
                          .watch(webtoonEpisodeProvider.notifier)
                          .starEpisode(value.toInt());
                      Navigator.pop(context);
                    },
                    child: Text("확인"),
                  ),
