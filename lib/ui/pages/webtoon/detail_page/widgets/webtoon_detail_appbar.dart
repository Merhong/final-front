...
class WebtoonDetailAppbar extends ConsumerWidget
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return AppBar(
      ...
      title: Text("${webtoonDTO.title}",
          style: TextStyle(
              fontWeight: FontWeight.bold,
              color: !isScroll ? Colors.transparent : Colors.black)),
      actions: [
                ...
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      ref
                          .read(webtoonDetailProvider.notifier)
                      ...
                      children: [
                        ...
                        Text("관심",
                            style: TextStyle(
                                fontSize: 18,
                                color:
                                    !isScroll ? Colors.white : Colors.black)),
                      ],
                    ),
                  ),
      ...
      shape: isScroll
          ? Border(bottom: BorderSide(color: CommonColors.grey, width: 1))
          : Border(),
    );
  }
}
