...
class WebtoonReReplyWrite extends ConsumerStatefulWidget {
  WebtoonReReplyWrite({
    Key? key,
  }) : super(key: key);

  @override
  _WebtoonReReplyWriteState createState() => _WebtoonReReplyWriteState();
}

class _WebtoonReReplyWriteState extends ConsumerState<WebtoonReReplyWrite> {
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: focusNode.hasFocus ? "주제와 무관한 내용 및 악플은 삭제될 수 있습니다." : "답글을 입력해주세요.",
                            isDense: true,
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            focusNode.unfocus();
                            _commentText.clear();
                            ref.read(webtoonReplyProvider.notifier).notifyReCommentCreate(replyReqDTO);
                          }
                        },
                      ),
                    ],
