...
class MyInterestAuthorDropdown extends ConsumerStatefulWidget {
  const MyInterestAuthorDropdown({super.key});

  @override
  _MyInterestAuthorDropdownState createState() => _MyInterestAuthorDropdownState();
}

class _MyInterestAuthorDropdownState extends ConsumerState<MyInterestAuthorDropdown> {
    ...
    return DropdownButtonFormField(
      ...
      onChanged: (value) {
        ...
        setState(() {
          _selected = value!;
          print(_selected);
          ref.read(myAuthorPageProvider.notifier).notifySort("${_selected}");
        });
      },
    );
  }
