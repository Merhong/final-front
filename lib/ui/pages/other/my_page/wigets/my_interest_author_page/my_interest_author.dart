...
class MyInterestAuthor extends ConsumerWidget {
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Container(
                ...
                child: Row(
                  children: [
                    buildPhoto(ref, interestAuthorDTOList[index],
                        context), // TODO 클릭시 작가페이지이동
                    SizedBox(width: sizeM10),
                    buildDescription(ref, interestAuthorDTOList[index],
                        context), // TODO 클릭시 작가페이지이동
                    SizedBox(width: sizeL20),
                    buildAlarmButton(
                        ref, interestAuthorDTOList[index], context),
                  ],
                ),
              );
            },
  ...
  InkWell buildAlarmButton(WidgetRef ref, InterestAuthorDTO interestAuthorDTO,
  ...
  Expanded buildDescription(WidgetRef ref, InterestAuthorDTO interestAuthorDTO,
      BuildContext context) {
    return Expanded(
      child: InkWell(
        // onTap: () {
  ...
  InkWell buildPhoto(WidgetRef ref, InterestAuthorDTO interestAuthorDTO,
      BuildContext context) {
    return InkWell(
      // onTap: () {
      //   ParamStore ps = ref.read(paramProvider);
      ...
      child: CircleAvatar(
        backgroundImage: NetworkImage(
            '${imageURL}/AuthorPhoto/${interestAuthorDTO.authorPhoto}'),
        radius: 37,
      ),
    );
  }
