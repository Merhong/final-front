...
class RatingStarRepository {
  Future<ResponseDTO> fetchRatingStar(
      String jwt, RatingStarReqDTO ratingStarReqDTO, int episodeId) async {
    try {
      Response response = await dio.post("/episodes/star/$episodeId",
          data: ratingStarReqDTO.toJson(),
          options: Options(headers: {"Authorization": "${jwt}"}));

      ResponseDTO responseDTO = new ResponseDTO.fromJson(response.data);

      RatingStarDTO ratingStarDTO =
          new RatingStarDTO.fromJson(responseDTO.data);
